        ...
        <div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-100">
            <md-card>
                <md-card-header data-background-color="red">
                    <h4 class="title">Sửa môn học tiên quyết</h4>
                    <h4 class="title">{{Mamh}}</h4>
                </md-card-header>
                <md-card-content>
                   
                   
                    <div>
                        <form method="post" action="/AdminTienquyet/Edit">
                            <input type="text" name="monhoc" :value="Mamh" style="display:none" />
                            <md-table table-header-color="red">
                                ...
                                <md-table-row v-for="item in Tienquyets" slot="md-table-row">
                                    <md-table-cell>

                                        <input type="checkbox" name="mamh[]" :value="item.maMh" checked/>
                                ...
                                <md-table-row v-for="(mon,index) in Monhocs" slot="md-table-row">
                                    <md-table-cell>
                                        ...
                                        <input type="checkbox" name="mamh[]" :value="mon.maMh" />
